...
{
    public class StringValidator_MinNumericChars : StringValidatorDecorator
    {
        private const String REG_EX = @"\d";
        private readonly int _minCount;
        private readonly String _errorMessage;

        public StringValidator_MinNumericChars(StringValidator a, int minCount, String errorMessage)
            : base(a)
        {
            _minCount = minCount;
