...
{
    [TestFixture()]
    public class DoubleValidator_LessThanTests
    {
        ...
        public void WhenDoubleValidator_LessThanValidates(double toValidate, double bound, bool orEqualTo, bool expectedResult)
        {
            string errorMessage = "DoubleValidator_LessThan Failed";
            Validator<double> validator = new ValidatorBaseCase<double>();
            validator = new DoubleValidator_LessThan(validator, bound, orEqualTo, errorMessage);
        ...
        [Test()]
        [TestCase(1, 1, false)]
        public void WhenDoubleValidator_LessThanFails_ErrorMessageIsGenerated(double toValidate, double bound, bool orEqualTo)
        {
            string errorMessage = "DoubleValidator_LessThan Failed";
            Validator<double> validator = new ValidatorBaseCase<double>();
            validator = new DoubleValidator_LessThan(validator, bound, orEqualTo, errorMessage);
